...
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "unzip")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzip")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleechhh")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleechunzippp")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleechzippp")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdlll")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdlll")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "TorrentLeech-Gdrive")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleechhh")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tleechunzippp"
)
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsizeee")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "statusss")
...
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdlll")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdlll")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gcloneee")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "uploaddd")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewmeee")
